...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       */
      $digest: function() {
        console.log('##tuan_log##: Begin digest');
        ...
        do { // "while dirty" loop
          ...
          do { // "traverse the scopes" loop
            console.log('##tuan_log##: begin loop scope watch array', current);
            if ((watchers = current.$$watchers)) {
              ...
              while (length--) {
                try {
                  ...
                  if (watch) {
                    console.log('##tuan_log##: begin check watch element in watcher array!', watch);
                    if ((value = watch.get(current)) !== (last = watch.last) &&
                        !(watch.eq
                            ? equals(value, last)
                            : (typeof value == 'number' && typeof last == 'number'
                               && isNaN(value) && isNaN(last)))) {
                      console.log('##tuan_log##: This watcher is dirty!', watch);
                      dirty = true;
                      lastDirtyWatch = watch;
                      console.log('##tuan_log##: watch.last beginning!', watch.last);
                      watch.last = watch.eq ? copy(value) : value;
                      console.log('##tuan_log##: watch.last after assigned!', watch.last);
       ...
       */
      $apply: function(expr) {
        console.log('##tuan_log##: Begin apply');
        try {
          beginPhase('$apply');
